...
export default function ColeccionesPage() {
  return (
    <main className="catalog-main container" style={{ paddingBottom: '5rem' }}>
      ...
      <section style={{ textAlign: 'center', padding: '0 1rem', marginBottom: '3rem' }}>
        <h1 style={{ fontSize: '3rem', color: 'var(--text-primary)', marginBottom: '1rem' }}>Todas las Colecciones</h1>
        <p style={{ color: 'var(--text-secondary)', maxWidth: '700px', margin: '0 auto', fontSize: '1.1rem' }}>
          Explora nuestro universo completo de escenografías temáticas estructuradas. Selecciona cualquier categoría para explorar el inventario.
        </p>
      </section>
